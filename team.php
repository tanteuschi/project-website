...
<div id="members">
    ...
    <div class="member">
        <a target="_blank" href="http://looove-design.com"><img class="hoverlink" src="./img/team/maxi.png" alt="Maxi"></a>
        <ul>
    ...
    <div class="member">
        <a target="_blank" href="http://ropensci.org"><img class="hoverlink" src="./img/team/scott.png" alt="Scott"></a>
        <ul>
...
<div class="background2">
    ...
    <div id="advisors">
        ...
        <div class="advisor">
            ...
            <p><a target="_blank" href="http://contentmine.org">Founder of ContentMine</a></p>
        </div>
